...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    handle_GPDMA1_Channel7.Init.Request = GPDMA1_REQUEST_TIM1_CH1;
    ...
    __HAL_LINKDMA(tim_pwmHandle, hdma[TIM_DMA_ID_CC1], handle_GPDMA1_Channel7);
    ...
    handle_GPDMA1_Channel6.Init.Request = GPDMA1_REQUEST_TIM1_CH2;
    ...
    __HAL_LINKDMA(tim_pwmHandle, hdma[TIM_DMA_ID_CC2], handle_GPDMA1_Channel6);
